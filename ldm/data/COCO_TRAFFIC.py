...
DATA_DIR = "/cluster/home/mathialm/poisoning/ML_Poisoning/data/datasets32/COCO_TRAFFIC_32"
ATTACKS = ["clean",
...
class COCO_TRAFFIC_Base(Dataset):
    def __init__(self,
                 data_root,
                 size=None,
...
class COCO_TRAFFIC_Train(COCO_TRAFFIC_Base):
...
class COCO_TRAFFIC_Val(COCO_TRAFFIC_Base):
...
class COCO_TRAFFIC_Val(COCO_TRAFFIC_Base):
    def __init__(self, attack, flip_p=0., **kwargs):
        assert attack in ATTACKS
        super().__init__(data_root=os.path.join(DATA_DIR, attack, "val"), flip_p=flip_p, **kwargs)
>>>>>>> b0fbb51694241122f772074c4335147f15e7533b
